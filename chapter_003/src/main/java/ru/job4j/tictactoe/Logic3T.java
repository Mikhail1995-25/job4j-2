...
public class Logic3T {
    ...
    public boolean isWinnerX() {
        return (this.fillBy(Figure3T::hasMarkX, 0, 0, 1, 0)
                ...
                || this.fillBy(Figure3T::hasMarkX, 2, 0, 0, 2)
    ...
    public boolean hasGap() {
        Arrays.stream(table)
                ...
                .anyMatch(figure3TS -> (figure3TS.hasMarkX() || figure3TS.hasMarkO()));
        return true;
    }
}
